...
<div class="max-w-md m-auto bg-gray-200 p-6 mt-10 rounded-md pt-6 pb-10 mb-6 text-center">
    ...
    <form action="../controllers/create_acc.php" method="post" class="mt-6">
        ...
        <input type="password" id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Password" class="p-2  w-full outline-none border-[1px] border-gray-300" required>
        <div class="flex justify-end">
            <input type="checkbox" id="show-password" onclick="showPassword()" hidden>
            <label for="show-password" class="cursor-pointer  text-blue-700 -mt-14 p-2 mb-4"><svg class="h-5 w-5 fill-slate-300" viewBox="0 0 18 18"><img src="../images/show.svg" alt=""></svg></label>
        </div>
        

        <div class="flex mb-4">
            <label for="" class="p-2">Birthday: </label>
            <input type="date" name="birthday" class="ml-4 p-2 outline-none border-[1px] border-gray-300" required>
        </div>
        ...
        <div class="flex mb-4">
            ...
            <select id="country" name="country" class="form-control mb-2 ml-4 p-2 outline-none w-full border-[1px] border-gray-300" required>
        ...
        <button type="submit" name="submit" id="register" class="m-auto p-2 bg-green-600 rounded-md pl-16 pr-16 font-bold mt-3 text-white">Sign Up</button>
